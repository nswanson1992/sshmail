# smail
A new mail tranfer protocol. Mail over ssh. Aims to simplify the old and outdated email systems we still use today.

The new protocol aims to centralize all mail actions to one port and securely authenticate over ssh. It can work well with imap for simplicity.
